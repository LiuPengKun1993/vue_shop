<template>
    <div>
            ...
            <el-table :data="userlist" border stripe>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <!-- 删除按钮 -->
                        <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDialogByID(scope.row.id)"></el-button>
                        <!-- 分配角色按钮 -->
        ...
        <el-dialog title="分配角色" :visible.sync="setRoleDialogVisible" width="50%" @close="setRoleDialogClosed">
            ...
            <!-- 底部区域 -->
            <span slot="footer" class="dialog-setRole-footer">
        ...
        return {
            ...
            addFormRules: {
                username: [
                    ...
                    { min: 3, max: 10, message: '用户名长度是3-10之间', trigger: 'blur' }
                ],
                password: [
